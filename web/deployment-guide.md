...
docker build -f Dockerfile \
  -t registry.digitalocean.com/cfe-k8/django-k8s-web:latest 
  -t registry.digitalocean.com/cfe-k8/django-k8s-web:v1 
```
...
- Image update:
```
kubectl set image deployment/django-k8s-web-deployment django-k8s-web=registry.digitalocean.com/cfe-k8/django-k8s-web:latest
```
...
Change 
```
image: registry.digitalocean.com/cfe-k8/django-k8s-web:latest
```
to
```
image: registry.digitalocean.com/cfe-k8/django-k8s-web:v1 
```
